...
import { LoaderCircle, CheckIcon, XIcon, ChevronRight, Settings, LogOut, Joystick, SquarePlus, Menu, ArrowRight, Sun, Moon, Monitor } from "lucide-react";
...
const buttonVariants = cva(
  "inline-flex hover:cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "text-white bg-indigo-600 hover:bg-indigo-700 border-2 border-indigo-900 shadow-md",
        destructive: "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline: "font-mono border-2 border-indigo-600 text-indigo-700 hover:bg-indigo-100 transition-colors group-hover:bg-indigo-700 group-hover:text-white",
...
function AppLogoIcon() {
  return /* @__PURE__ */ jsx("span", { className: "text-6xl", children: "👾" });
}
...
function AppLogo() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex aspect-square size-8 text-4xl items-center justify-center rounded-md", children: "👾" }),
    /* @__PURE__ */ jsx("div", { className: "ml-1 grid flex-1 text-left text-md", children: /* @__PURE__ */ jsx("span", { className: "mb-0.5 truncate tracking-widest font-semibold uppercase", children: "Browser Playground" }) })
  ] });
}
const mainNavItems = [
  // {
    ...
    /* @__PURE__ */ jsx("div", { className: "border-sidebar-border/80 border-b", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex h-16 items-center px-4 md:max-w-7xl", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:hidden", children: /* @__PURE__ */ jsxs(Sheet, { children: [
        ...
        /* @__PURE__ */ jsxs(SheetContent, { side: "left", className: "bg-sidebar flex h-full w-64 flex-col items-stretch justify-between", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-6 flex h-full flex-1 flex-col space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col justify-between text-sm", children: [
            /* @__PURE__ */ jsx("div", { className: "flex flex-col space-y-4", children: mainNavItems.map((item) => /* @__PURE__ */ jsxs(Link, { href: item.url, className: "flex items-center space-x-2 font-medium", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center space-x-2", children: [
        /* @__PURE__ */ jsx("div", { className: "relative flex items-center space-x-1", children: /* @__PURE__ */ jsx("div", { className: "hidden lg:flex", children: rightNavItems.map((item, index) => /* @__PURE__ */ jsxs(NavigationMenuItem, { className: "relative flex h-full items-center", children: [
          /* @__PURE__ */ jsxs(
            Link,
            {
              href: item.url,
        ...
        auth.user ? /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: route("login"), children: /* @__PURE__ */ jsx(Button, { variant: "outline", children: "Login" }) }),
          /* @__PURE__ */ jsx(Link, { href: route("register"), children: /* @__PURE__ */ jsx(Button, { children: "Register" }) })
        ] })
      ] })
    ] }) }),
...
function Heading({ title, description }) {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "mt-6 mb-10 p-6 bg-gradient-to-r from-purple-600 to-indigo-800 rounded-lg border-4 border-black shadow-lg", children: [
    /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-white text-center mb-2 font-mono uppercase", children: title }),
    description && /* @__PURE__ */ jsx("p", { className: "text-white text-center text-lg", children: description })
  ] }) });
}
...
function Create() {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs: breadcrumbs$5, children: [
    /* @__PURE__ */ jsx(Head, { title: "New Game" }),
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 md:px-8", children: [
      /* @__PURE__ */ jsx(Heading, { title: "New Game", description: "🔥 Add a new game to share it with the community! 🔥" }),
      /* @__PURE__ */ jsx("div", { className: "space-y-6 md:max-w-2xl mx-auto", children: /* @__PURE__ */ jsxs(Card, { className: "border-2 border-gray-900 shadow-lg bg-gray-50 overflow-hidden", children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "bg-gradient-to-r from-indigo-500 to-purple-600 py-4", children: /* @__PURE__ */ jsx("h3", { className: "text-xl font-mono font-bold text-white text-center uppercase", children: "Game Details" }) }),
        /* @__PURE__ */ jsx(CardContent, { className: "p-6 pt-8", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3", children: [
            /* @__PURE__ */ jsxs(Label, { htmlFor: "builder", className: "text-lg font-mono text-gray-800 flex items-center uppercase", children: [
              "Builder",
              /* @__PURE__ */ jsx("span", { className: "text-sm lowercase ml-2", children: "(Only X handles supported)" })
            ] }),
            /* @__PURE__ */ jsx(
              Input,
              {
            ...
            /* @__PURE__ */ jsx(InputError, { className: "mt-2 font-mono", message: errors.builder })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "name", className: "text-lg font-mono text-gray-800 flex items-center uppercase", children: "Game Name" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "name",
            ...
            /* @__PURE__ */ jsx(InputError, { className: "mt-2 font-mono", message: errors.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "link", className: "text-lg font-mono text-gray-800 flex items-center uppercase", children: "Game Link" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "link",
            ...
            /* @__PURE__ */ jsx(InputError, { className: "mt-2 font-mono", message: errors.link })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-3", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "description", className: "text-lg font-mono text-gray-800 flex items-center uppercase", children: "Description" }),
            /* @__PURE__ */ jsx(
              Textarea,
              {
                id: "description",
            ...
            /* @__PURE__ */ jsx(InputError, { className: "mt-2 font-mono", message: errors.description })
          ] }),
          /* @__PURE__ */ jsx(CardFooter, { className: "px-0 pt-4 flex items-center justify-between", children: /* @__PURE__ */ jsx(Button, { size: "lg", disabled: processing, children: "Save Game" }) })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "text-center mt-8", children: /* @__PURE__ */ jsx(
        Link,
        {
          ...
          children: "← BACK TO GAME DIRECTORY"
        }
      ) })
    ] })
  ] });
...
function Index({ listings }) {
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs: breadcrumbs$4, children: [
    /* @__PURE__ */ jsx(Head, { title: "Game Directory" }),
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 md:px-8", children: [
      /* @__PURE__ */ jsx(Heading, { title: "Game Directory", description: "⭐ Discover amazing indie games from our community! ⭐" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: listings.data.length > 0 ? listings.data.map((listing) => /* @__PURE__ */ jsxs(Card, { className: "overflow-hidden border-2 border-gray-900 shadow-md hover:shadow-xl transition-all duration-300 bg-gray-50 group", children: [
        /* @__PURE__ */ jsx(CardHeader, { className: "bg-gradient-to-r from-indigo-500 to-purple-600 py-4 px-6", children: /* @__PURE__ */ jsx(CardTitle, { className: "text-white font-mono text-xl truncate", children: listing.name }) }),
        /* @__PURE__ */ jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsx("p", { className: "text-gray-700 line-clamp-3 mb-4 h-20", children: listing.description }) }),
        /* @__PURE__ */ jsxs(CardFooter, { className: "bg-gray-100 p-4 border-t border-gray-200 flex items-center justify-between", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center space-x-3", children: /* @__PURE__ */ jsx("a", { target: "_blank", href: "https://www.x.com/" + listing.builder, children: /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700 hover:cursor underline", children: listing.builder }) }) }),
          /* @__PURE__ */ jsx("a", { target: "_blank", href: listing.link, children: /* @__PURE__ */ jsx(Button, { size: "lg", className: "uppercase", children: "Play" }) })
        ] })
      ] }, listing.id)) : /* @__PURE__ */ jsxs("div", { className: "col-span-full text-center p-12 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50", children: [
        /* @__PURE__ */ jsx("div", { className: "text-xl text-gray-500 mb-2 uppercase", children: "No Games Found" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500 mb-4", children: "Be the first to add a game to our directory!" }),
        /* @__PURE__ */ jsx(Link, { href: route("listings.create"), prefetch: true, children: /* @__PURE__ */ jsxs(Button, { children: [
          "Add Your Game",
          /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1 size-4" })
        ] }) })
      ] }) }),
      listings && listings.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-10 text-center", children: /* @__PURE__ */ jsxs(
        Button,
        {
...
function Show({ listing }) {
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs: breadcrumbs$3, children: [
    /* @__PURE__ */ jsx(Head, { title: "Create listing" }),
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 space-y-6 md:max-w-2xl", children: [
      /* @__PURE__ */ jsx(Heading, { title: "Create a Listing", description: "Add a link to your game and get discovered!" }),
      /* @__PURE__ */ jsx("p", { children: listing.name })
    ] })
  ] });
}
...
function Welcome() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { title: "Welcome", children: [
      ...
      /* @__PURE__ */ jsx("link", { href: "https://fonts.bunny.net/css?family=montserrat:400,500,600", rel: "stylesheet" })
    ] }),
  ...
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({
        ...
        "./pages/listings/create.tsx": __vite_glob_0_7,
        "./pages/listings/index.tsx": __vite_glob_0_8,
        "./pages/listings/show.tsx": __vite_glob_0_9,
        "./pages/settings/appearance.tsx": __vite_glob_0_10,
        "./pages/settings/password.tsx": __vite_glob_0_11,
        "./pages/settings/profile.tsx": __vite_glob_0_12,
        "./pages/welcome.tsx": __vite_glob_0_13
      });
