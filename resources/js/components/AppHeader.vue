...
import { Joystick, SquarePlus, Menu } from 'lucide-vue-next';
                ...
                <div class="lg:hidden">
                    <Sheet>
                        ...
                        <SheetContent side="left" class="w-[300px] p-6">
                            ...
                            <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-12">
                        ...
                        <DropdownMenuTrigger :as-child="true">
                            ...
                            >
                                <Avatar class="size-8 overflow-hidden rounded-full">
                                    <AvatarImage v-if="auth.user.avatar" :src="'https://fls-9e511cc4-73e8-4419-b3b4-50d0f2a13cbe.laravel.cloud/' + auth.user.avatar" :alt="auth.user.name" />
